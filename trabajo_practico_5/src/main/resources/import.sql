...
insert into carreras(codigo_carrera , nombre , cantidad_anos , estado) values (2 , 'Lic. Administración' , 5 , 1);
insert into carreras(codigo_carrera , nombre , cantidad_anos , estado) values (3 , 'Lic. Ec. Política' , 5 , 1);
insert into carreras(codigo_carrera , nombre , cantidad_anos , estado) values (4 , 'Lic. Administración' , 5 , 1);
insert into carreras(codigo_carrera , nombre , cantidad_anos , estado) values (5 , 'Doc. en Políticas Públicas' , 6 , 1);
